...
def parse_args():
    parser = argparse.ArgumentParser(description="Test GPT-2 Entropy Reduction on grammatical constructions")
    
    parser.add_argument('--template_dir', type=str, default='../EMNLP2018/templates',
                        help='Location of the template files')
    parser.add_argument('--output_file', type=str, default='gpt2_entropy_results.pickle',
...
class GPT2Evaluator:
    ...
    def get_sentence_word_scores(self, sentence):
        ...
        # Calculate probabilities and Shannon Entropy (nats)
        ...
        for i in range(len(token_ids) - 1):
            ...
            token_entropy = entropies[0, i].item()
            word = words[i + 1]
