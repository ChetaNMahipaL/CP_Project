#!/usr/bin/env python3
"""
Simple example of evaluating and comparing LSTM multitask model on syntactic constructions.
...
def main():
    ...
    RESULTS_FILE = f'{TEMPLATE_DIR}/lstm_multitask_results.pickle'
    OUTPUT_DIR = '../results/lstm_multitask'
    
    print("="*80)
    print("LSTM Multitask Model - Syntactic Evaluation Example")
    print("="*80)
    ...
    if not os.path.exists(MODEL_FILE):
        ...
        print("  python main.py --lm_data ../data/lm_data --ccg_data ../data/ccg_data \\")
        print("    --save ../models/lstm.pt --save_lm_data ../models/lm_data.bin")
        return
    ...
    if os.path.exists(RESULTS_FILE):
        ...
        print("\nStep 1: Evaluating LSTM on syntactic constructions...")
        print("-"*80)
    ...
    print("="*80)
    print("\nNext steps:")
    print("  1. View detailed analysis: cat ../results/lstm_multitask/analysis_overall.txt")
    print("  2. Compare with other models (GPT-2, N-gram)")
    print("  3. Check relative clause results: ../results/lstm_multitask/analysis_full.txt")
