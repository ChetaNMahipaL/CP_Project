...
def parse_args():
    parser = argparse.ArgumentParser(description="Analyze LSTM multitask evaluation results")
    
    parser.add_argument('--results_file', type=str, required=True,
                        help='Path to LSTM multitask results pickle file')
    parser.add_argument('--output_dir', type=str, default='../results/lstm_multitask',
...
def compute_sentence_accuracy(gram_sent, ungram_sent):
    """
    Compute accuracy by comparing grammatical vs ungrammatical sentence scores.
    """
...
def analyze_results(results):
    """
    Analyze LSTM results across all test cases.
...
def print_overall_results(analysis):
    ...
    output = []
    output.append("\n" + "="*60)
    output.append("LSTM MULTITASK EVALUATION RESULTS - OVERALL")
    output.append("="*60)
...
def print_condensed_results(analysis):
    ...
    output = []
    output.append("\n" + "="*60)
    output.append("LSTM MULTITASK EVALUATION RESULTS - CONDENSED")
    output.append("="*60)
...
def print_full_results(analysis):
    ...
    output = []
    output.append("\n" + "="*80)
    output.append("LSTM MULTITASK EVALUATION RESULTS - FULL (WITH SAMPLES)")
    output.append("="*80)
