...
def parse_args():
    parser = argparse.ArgumentParser(description="Analyze LSTM multitask evaluation results using Critical-Region Surprisal")
    
    parser.add_argument('--results_file', type=str, required=True,
                        help='Path to LSTM multitask results pickle file')
    parser.add_argument('--output_dir', type=str, default='../h1_results/lstm_multitask',
...
def analyze_results(results):
    """
    Analyze LSTM multitask results using Critical-Region Surprisal across all test cases.
...
def print_overall_results(analysis):
    ...
    output = []
    output.append("\n" + "="*80)
    output.append("LSTM MULTITASK EVALUATION RESULTS - OVERALL (CRITICAL-REGION SURPRISAL)")
    output.append("="*80)
...
def print_condensed_results(analysis):
    ...
    output = []
    output.append("\n" + "="*80)
    output.append("LSTM MULTITASK EVALUATION RESULTS - CONDENSED (CRITICAL-REGION SURPRISAL)")
    output.append("="*80)
...
def print_full_results(analysis):
    ...
    output = []
    output.append("\n" + "="*90)
    output.append("LSTM MULTITASK EVALUATION RESULTS - FULL (CRITICAL-REGION SURPRISAL)")
    output.append("="*90)
