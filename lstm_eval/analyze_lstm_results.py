...
def parse_args():
    parser = argparse.ArgumentParser(description="Analyze LSTM evaluation results")
...
def print_overall_results(analysis):
    ...
    output = []
    output.append("\n" + "="*60)
    output.append("LSTM EVALUATION RESULTS - OVERALL")
    output.append("="*60)
...
def print_condensed_results(analysis):
    ...
    output = []
    output.append("\n" + "="*60)
    output.append("LSTM EVALUATION RESULTS - CONDENSED")
    output.append("="*60)
...
def print_full_results(analysis):
    ...
    output = []
    output.append("\n" + "="*80)
    output.append("LSTM EVALUATION RESULTS - FULL (WITH SAMPLES)")
    output.append("="*80)
